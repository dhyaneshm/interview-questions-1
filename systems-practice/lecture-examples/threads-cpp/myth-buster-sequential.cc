...
static void compileCS110ProcessCountMap(const unordered_set<string>& sunetIDs,
					map<unsigned short, unsigned short>& processCountMap) {
...
static void publishLeastLoadedMachineInfo(const map<unsigned short, unsigned short>& processCountMap) {
  auto compfn = [](const pair<unsigned short, unsigned short>& one,
		   const pair<unsigned short, unsigned short>& two) -> bool {
